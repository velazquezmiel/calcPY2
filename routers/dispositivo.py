...
def atualizar_dispositivo( id_dispositivo: int, dispositivo_autualizado: DispositivoUpdate):
    dispositivo = DispositivoDB.get_or_none (DispositivoDB.id == id_dispositivo)
    dispositivo.nome = dispositivo.consumo
    dispositivo_autualizado.nome = dispositivo_autualizado.consumo
